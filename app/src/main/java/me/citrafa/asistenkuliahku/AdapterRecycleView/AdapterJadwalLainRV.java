...
public class AdapterJadwalLainRV extends RealmRecyclerViewAdapter<JadwalLainModel, AdapterJadwalLainRV.MyViewHolder> {
    ...
    public AdapterJadwalLainRV(OrderedRealmCollection<JadwalLainModel> data) {
        super(data, true);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        final JadwalLainModel jl = getItem(position);
        ...
        holder.ibutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                showPopupMenu(holder.ibutton,position);
            }
        });
    }
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            switch (menuItem.getItemId()){
                case R.id.MenuJLUbah:
                    Toast.makeText(mContext, "clicked : Ubah", Toast.LENGTH_SHORT).show();
                    return true;
                case R.id.MenuJLHapus:
                    Toast.makeText(mContext, "clicked : Hapus", Toast.LENGTH_SHORT).show();
                    return true;
            }
            return false;
        }
