...
import me.citrafa.asistenkuliahku.fragment_dashboard;
...
//        });
        ...
        fragmentManager.beginTransaction().replace(R.id.content_dashboard, new fragment_dashboard()).addToBackStack(null).commit();
    }
